...
const PandaIcon = (props) => (
    <Icon component={PandaSvg} {...props}></Icon>
)

class IconCom extends Component {
    constructor(props) {
        super(props);
        this.state = {
        }
    ...
    render() {
        return (<div className='icon-demo'>
            ...
            <Icon type='heart' theme='twoTone' twoToneColor='#eb2f96'></Icon>
            <Icon component={this.HeartSvg} style={{ color: 'hotpink' }}></Icon>
            <PandaIcon style={{ fontSize: 24 }}></PandaIcon>
            <IconFont type='icon-tuichu'></IconFont>
            <IconFont type='icon-facebook' ></IconFont>
        </div>)
    }
}
